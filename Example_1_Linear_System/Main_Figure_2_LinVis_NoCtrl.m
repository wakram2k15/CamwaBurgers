...
%         plot(Time, E(:,6), '-k');
        grid on;
        title('Evolution of solution $\widetilde{z}_h$ (without control)', 'Interpreter', 'latex')
        xlabel('Time $t$', 'Interpreter', 'latex')
        ylabel('$\|\widetilde{z}_h(t)\|$', 'Interpreter', 'latex')
...
%         semilogy(Time, E(:,6)/E(1,6), '-k');
        grid on;
        title('Evolution of solution $\widetilde{z}_h$ (without control) on log-scale', 'Interpreter', 'latex')
        xlabel('Time $t$', 'Interpreter', 'latex')
        ylabel('$\|\widetilde{z}_h(t)\|$ on log-scale', 'Interpreter', 'latex')
